...
import scheduleReducer from 'src/reducers/schedule';
...
/* REDUCERS */
const eventsList = [
  { uuid: 1, name: 'My training', color: '#f15850', desc: 'short desc'  },
  { uuid: 2, name: 'English lesson', color: '#4aad93', desc: 'short desc'  }
];

const userSchedule = [
  {eventUUID: 1, day: 'Monday', startinterval: '11:00'},
  {eventUUID: 2, day: 'Tuesday', startinterval: '12:00'}
]
...
config.addReducer('schedule', scheduleReducer, userSchedule);
config.addReducer('eventsList', eventsReducer, eventsList);
